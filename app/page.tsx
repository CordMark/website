...
const companyOsSteps = [
  {
    ...
    body: "「部署ごとに閲覧制限できますか？」をエンジニアに聞かなくていい。仕様と実装を知るAIが根拠付きで答え、顧客への返事は当日に戻る。開発の手は止まらない。",
  },
  {
    tag: "02 / ASK",
    who: "エンジニア",
  ...
  },
  {
    ...
    body: "重要な判断が、経緯と現場の言葉のまま届く。決まらずに止まっている問いも、報告に書かれる前に見える。「できています」の裏で育つ問題を、手遅れになる前に知る。",
  },
  {
    tag: "06 / AI-NATIVE",
